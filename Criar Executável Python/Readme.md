...
4) Execute o comando para criar o executável:  
 ...
 ```
## 📌 Sumário Rápido  
- [O que você precisa](#o-que-você-precisa) - [Requisitos](#-o-que-você-precisa](https://github.com/ThiagoMaria-SecurityIT/Tutoriais/blob/main/Criar%20Execut%C3%A1vel%20Python/Readme.md#%EF%B8%8F-o-que-voc%C3%AA-precisa))
